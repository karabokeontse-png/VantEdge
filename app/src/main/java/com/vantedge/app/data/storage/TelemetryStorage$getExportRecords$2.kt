...
@DebugMetadata(c = "com.vantedge.app.data.storage.TelemetryStorage$getExportRecords$2", f = "TelemetryStorage.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes5.dex */
final class TelemetryStorage$getExportRecords$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends TelemetryRecord>>, Object> {
    int label;
    final /* synthetic */ TelemetryStorage this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TelemetryStorage$getExportRecords$2(TelemetryStorage telemetryStorage, Continuation<? super TelemetryStorage$getExportRecords$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TelemetryStorage$getExportRecords$2(this.this$0, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super List<TelemetryRecord>> continuation) {
        return ((TelemetryStorage$getExportRecords$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.label) {
            case 0:
                ...
                readGate0Records = this.this$0.readGate0Records(500);
